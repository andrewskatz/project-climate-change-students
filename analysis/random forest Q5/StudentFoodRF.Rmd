---
title: "Variable Importance - Food Availability"
author: "Katz et al."
date: "5/18/2021"
...
Q5_removals <- c("Q5a","Q5b", "Q5c", "Q5d", "Q5e", "Q5f", "Q5h", "Q5i", "Q5j")
...
Create random forest for Q5g with tidymodels framework
```{r}
...
q5g_split <- train_df %>% 
  initial_split(strata = Q5g)

q5g_train <- training(q5g_split) # 2440 x 288
q5g_test <- testing(q5g_split) # 812 x 288
...
# rf_mod <- randomForest(formula = Q5g ~ ., 
#                        data = q5g_train,
#                        ntree = 1000,
#                        proximity = TRUE,
...
p <- featureImportance %>% 
  ...
  ggtitle("Random Forest Variable Importance for Career Interest in Addressing Food Availability")

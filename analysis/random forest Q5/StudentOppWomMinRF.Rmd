---
title: "Random Forest - Opportunities for Women and Minorities"
author: "Katz et al."
date: "5/18/2021"
...
Q5_removals <- c("Q5a","Q5b", "Q5c", "Q5d", "Q5e", "Q5f", "Q5g", "Q5h", "Q5j")
...
q5i_split <- train_df %>% 
  initial_split(strata = Q5i)

q5i_train <- training(q5i_split) # 2440 x 288
q5i_test <- testing(q5i_split) # 812 x 288
...
# rf_mod <- randomForest(formula = Q5i ~ ., 
#                        data = q5i_train,
#                        ntree = 1000,
#                        proximity = TRUE,
...
p <- featureImportance %>% 
  ...
  ggtitle("Random Forest Variable Importance for Career Interest in Opportunities for Women and/or Minorities")

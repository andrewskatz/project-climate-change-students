---
title: "Random Forest - Interest in Water Supply"
author: "Katz et al."
date: "5/18/2021"
...
Q5_removals <- c("Q5a","Q5b", "Q5c", "Q5d", "Q5e", "Q5g", "Q5h", "Q5i", "Q5j")
...
Create random forest for Q5f with tidymodels framework
```{r}
...
q5f_split <- train_df %>% 
  initial_split(strata = Q5f)

q5f_train <- training(q5f_split) # 2440 x 288
q5f_test <- testing(q5f_split) # 812 x 288
...
# rf_mod <- randomForest(formula = Q5f ~ ., 
#                        data = q5f_train,
#                        ntree = 1000,
#                        proximity = TRUE,
...
p <- featureImportance %>% 
  ...
  ggtitle("Random Forest Variable Importance for Career Interest in Water Supply")

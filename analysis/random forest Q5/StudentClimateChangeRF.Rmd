...
# remove other Q5 variables aside from 5d

Q5_removals <- c("Q5a", "Q5b", "Q5c", "Q5e", "Q5f", "Q5g", "Q5h", "Q5i", "Q5j")
...
Create random forest for Q5d with tidymodels framework
```{r}
...
q5d_split <- train_df %>% 
  initial_split(strata = Q5d)

q5d_train <- training(q5d_split) # 2440 x 288
q5d_test <- testing(q5d_split) # 812 x 288
...
# rf_mod <- randomForest(formula = Q5d ~ ., 
#                        data = q5d_train,
#                        ntree = 1000,
#                        proximity = TRUE,

...
Q5_removals <- c("Q5a", "Q5c", "Q5d", "Q5e", "Q5f", "Q5g", "Q5h", "Q5i", "Q5j")
...
Create random forest for Q5b with tidymodels framework
```{r}
...
q5b_split <- train_df %>% 
  initial_split(strata = Q5b)

q5b_train <- training(q5b_split) # 2440 x 288
q5b_test <- testing(q5b_split) # 812 x 288
...
# rf_mod <- randomForest(formula = Q5b ~ ., 
#                        data = q5b_train,
#                        ntree = 1000,
#                        proximity = TRUE,
...
p <- featureImportance %>% 
  ...
  ggtitle("Random Forest Variable Importance for Career Interest in Disease")

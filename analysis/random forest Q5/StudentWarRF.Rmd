---
title: "Random Forest - Terrorism and War"
author: "Katz et al."
date: "5/18/2021"
...
Q5_removals <- c("Q5a","Q5b", "Q5c", "Q5d", "Q5f", "Q5g", "Q5h", "Q5i", "Q5j")
...
Create random forest for Q5e with tidymodels framework
```{r}
...
q5e_split <- train_df %>% 
  initial_split(strata = Q5e)

q5e_train <- training(q5e_split) # 2440 x 288
q5e_test <- testing(q5e_split) # 812 x 288
...
# rf_mod <- randomForest(formula = Q5e ~ ., 
#                        data = q5e_train,
#                        ntree = 1000,
#                        proximity = TRUE,
...
p <- featureImportance %>% 
  ...
  ggtitle("Random Forest Variable Importance for Career Interest in Addressing Terrorism and War ")

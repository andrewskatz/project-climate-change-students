---
title: "Random Forest - Environmental Degradation"
author: "Katz et al."
date: "5/18/2021"
...
Q5_removals <- c("Q5a","Q5b", "Q5c", "Q5d", "Q5e", "Q5f", "Q5g", "Q5h", "Q5i")
...
Create random forest for Q5j with tidymodels framework
```{r}
...
q5j_split <- train_df %>% 
  initial_split(strata = Q5j)

q5j_train <- training(q5j_split) # 2440 x 288
q5j_test <- testing(q5j_split) # 812 x 288
...
# rf_mod <- randomForest(formula = Q5j ~ ., 
#                        data = q5j_train,
#                        ntree = 1000,
#                        proximity = TRUE,
...
p <- featureImportance %>% 
  ...
  ggtitle("Random Forest Variable Importance for Career Interest in Addressing Environmental Degradation")

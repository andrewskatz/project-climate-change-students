...
mod1_ord_mono_des_Q16b <- brm(formula = ordered(Q16b) ~  mo(Q8b_ord) + mo(Q8d_ord) + mo(Q8e_ord) + mo(Q8f_ord) + mo(Q8g_ord) + mo(Q8h_ord) + mo(Q14a_ord) + mo(Q14b_ord) + mo(Q14c_ord) + mo(Q14d_ord) + mo(Q14e_ord)+ mo(Q14f_ord) + mo(Q14g_ord) + mo(Q18e_ord) + mo(Q18f_ord),
                     data = climate_data,
...
file_name <- "mod1_ord_mono_des_Q16b_2.rds"

mod1_ord_mono_des_Q16b %>% write_rds(file = paste0(path, file_name))
```

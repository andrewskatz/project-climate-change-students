...
mod1_ord_mono_des_Q16c <- brm(formula = ordered(Q16c) ~  mo(Q8b_ord) + mo(Q8d_ord) + mo(Q8e_ord) + mo(Q8f_ord) + mo(Q8g_ord) + mo(Q8h_ord) + mo(Q14a_ord) + mo(Q14b_ord) + mo(Q14c_ord) + mo(Q14d_ord) + mo(Q14e_ord)+ mo(Q14f_ord) + mo(Q14g_ord) + mo(Q18e_ord) + mo(Q18f_ord),
                     data = climate_data,
...
file_name <- "mod1_ord_mono_des_Q16c_2.rds"

mod1_ord_mono_des_Q16c %>% write_rds(file = paste0(path, file_name))
```
...
get_variables(mod1_ord_mono_des_Q16c)
...
plot(mod1_ord_mono_des_Q16c)

```


```{r}
summary(mod1_ord_mono_des_Q16c)
```
...
# mod2_lin_des_Q16a <- brm(formula = Q16abce ~  mo(Q8b) + mo(Q8d) + mo(Q8e) + mo(Q8f) + mo(Q8g) + mo(Q8h) +mo(Q14a) + mo(Q14b) + mo(Q14c) + mo(Q14d) + mo(Q14e)+ mo(Q14f) + mo(Q18e) + mo(Q18f),
#                      data = climate_data,
#                      family = gaussian(),
#                      cores = parallel::detectCores())
